...
I ended up with more classes than I initially thought I would need. This came about as I am trying to keep State manageable and decoupled from UI. That's why I split out SudokuGame.kt with GameSnapshot.kt. SudokuGame.kt will keep the state, while GameSnapshot.kt will give a read-only view of the state.
